...
| `onmessagereceived`  | Fired when a text message has been received.<br>The event contains a `string` representing the content and a `string` representing the issuer |
