...
const stateMachine = {};
stateMachine[CALL_STATE.FREE] = [STATE_ACTIONS.SEND, STATE_ACTIONS.IQ, STATE_ACTIONS.ERROR, STATE_ACTIONS.ACK, STATE_ACTIONS.EVENT, STATE_ACTIONS.PROPOSE, STATE_ACTIONS.UNREACH];
...
stateMachine[CALL_STATE.TRYING] = [STATE_ACTIONS.RING, STATE_ACTIONS.RETRACT, STATE_ACTIONS.SEND, STATE_ACTIONS.IQ, STATE_ACTIONS.ERROR, STATE_ACTIONS.ACK, STATE_ACTIONS.EVENT, STATE_ACTIONS.UNREACH];
stateMachine[CALL_STATE.RINGING] = [STATE_ACTIONS.DECLINE, STATE_ACTIONS.PROCEED, STATE_ACTIONS.RETRACT, STATE_ACTIONS.SEND, STATE_ACTIONS.IQ, STATE_ACTIONS.ERROR, STATE_ACTIONS.ACK, STATE_ACTIONS.EVENT, STATE_ACTIONS.UNREACH];
stateMachine[CALL_STATE.PROCEEDED] = [STATE_ACTIONS.INITIATE, STATE_ACTIONS.RETRACT, STATE_ACTIONS.CANCEL, STATE_ACTIONS.SEND, STATE_ACTIONS.IQ, STATE_ACTIONS.ERROR, STATE_ACTIONS.ACK, STATE_ACTIONS.EVENT, STATE_ACTIONS.UNREACH];
stateMachine[CALL_STATE.OFFERING] = [STATE_ACTIONS.ACCEPT, STATE_ACTIONS.RETRACT, STATE_ACTIONS.TRANSPORT, STATE_ACTIONS.ACTIVATE, STATE_ACTIONS.CANCEL, STATE_ACTIONS.SEND, STATE_ACTIONS.IQ, STATE_ACTIONS.ERROR, STATE_ACTIONS.ACK, STATE_ACTIONS.EVENT, STATE_ACTIONS.UNREACH];
stateMachine[CALL_STATE.ACTIVE] = [STATE_ACTIONS.TRANSPORT, STATE_ACTIONS.END, STATE_ACTIONS.ACTIVATE, STATE_ACTIONS.MUTE, STATE_ACTIONS.UNMUTE, STATE_ACTIONS.SEND, STATE_ACTIONS.IQ, STATE_ACTIONS.ERROR, STATE_ACTIONS.ACK, STATE_ACTIONS.EVENT, STATE_ACTIONS.UNREACH];
stateMachine[CALL_STATE.ENDED] = [STATE_ACTIONS.SEND, STATE_ACTIONS.ERROR, STATE_ACTIONS.ACK, STATE_ACTIONS.EVENT, STATE_ACTIONS.UNREACH];
